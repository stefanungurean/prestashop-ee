...
<div class="wirecardcheckoutseamless-wrapper">
    <img class="wirecardcheckoutseamless-logo" src="{$module_dir|escape:'htmlall':'UTF-8'}views/img/wirecard-logo.png" alt="Wirecard CEE" border="0"/><br/>
    <p class="wirecardcheckoutseamless-intro">{l s='Wirecard - Your Full Service Payment Provider - Comprehensive solutions from one single source' mod='wirecardpaymentgateway'}</p>
